package millbuild.`rocket-chip`.dependencies.hardfloat

import _root_.mill.runner.MillBuildRootModule

object MiscInfo_common {
  implicit lazy val millBuildRootModuleInfo: _root_.mill.runner.MillBuildRootModule.Info = _root_.mill.runner.MillBuildRootModule.Info(
    Vector("/home/lh/ysyx/ysyx-workbench/ysyxSoC/out/mill-launcher/0.11.7.jar").map(_root_.os.Path(_)),
    _root_.os.Path("/home/lh/ysyx/ysyx-workbench/ysyxSoC/rocket-chip/dependencies/hardfloat"),
    _root_.os.Path("/home/lh/ysyx/ysyx-workbench/ysyxSoC"),
  )
...
class common extends _root_.mill.main.RootModule.Foreign(Some(_root_.mill.define.Segments.labels("foreign-modules", "rocket-chip", "dependencies", "hardfloat", "common"))) {

//MILL_ORIGINAL_FILE_PATH=/home/lh/ysyx/ysyx-workbench/ysyxSoC/rocket-chip/dependencies/hardfloat/common.sc
